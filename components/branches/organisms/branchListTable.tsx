...
export function BranchListTable({
  ...
  onDeactivate,
  title = "Branch list",
  description = "This is a directory of all your branches on this platform. Use it to scan live locations, opening branches, staffing coverage, and core branch status quickly.",
  ...
  const branchActions = useMemo<CustomTableAction<Branch>[]>(
    () => [
      ...
      },
      {
        ...
        onSelect: (branch) => setPendingDeactivate(branch),
      },
    ],
    [router],
  );
  ...
  return (
    <>
      ...
      <DeactivateBranchModal
        ...
        branchName={pendingDeactivate?.name ?? "this branch"}
