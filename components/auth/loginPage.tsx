...
export function LoginPage() {
  ...
  const registerHref = getAuthRouteWithNext("/auth/register", nextPath);
        ...
        <div className="flex w-full flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              onClick={() => handleMockProvider("Phone sign-in stays mocked in this build.")}
            >
              Continue with Phone
            </button>
            ...
            <button
              ...
              onClick={() => handleMockProvider("Google sign-in stays mocked in this build.")}
            >
              <Image
            ...
            <button
              type="button"
              className={`${authProviderButtonClassName} gap-2`}
              onClick={() => handleMockProvider("Facebook sign-in stays mocked in this build.")}
            >
              <Image
