    ...
    <section className="space-y-10">
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:hidden">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          {sessions.map((session) => (
            <article
              key={session.id}
              className="relative h-[293px] overflow-hidden rounded-[1rem]"
            >
              <Image
              ...
              <div
                className={clsx(
                  "absolute left-6 top-6 inline-flex w-fit items-center gap-[6px] overflow-hidden rounded-full bg-bg-surface px-2 py-1 backdrop-blur-[7.8px]",
